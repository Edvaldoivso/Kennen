...
setTimeout(function(){
  fProp("frmshc.Prescricao.Main.ModalMaterial.cnProfissional","value",cc.global.cnProfissional)
...
fProp('frmshc.Prescricao.Main.ModalMaterial.doSeNecessario','value','N')
